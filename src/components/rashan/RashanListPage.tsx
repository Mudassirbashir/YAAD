        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="hidden sm:inline">
                {language === 'ur' ? 'ایپ پر واپس جائیں' : 'Back to App'}
              </span>
            </button>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-[#005039] text-base tracking-tight">
                YAAD <span className="text-xs font-normal opacity-80">(یاد)</span>
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>{language === 'ur' ? 'شاپنگ شروع کریں' : 'Open YAAD'}</span>
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-14 space-y-16">
        ...
        <section className="text-center space-y-6 max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#005039]/10 text-[#005039] text-xs font-bold tracking-wide">
            ...
            <span>
              {language === 'ur'
                ? 'مستند پاکستانی گھریلو راشن گائیڈ'
                : language === 'roman-urdu'
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#003d2b] tracking-tight leading-tight sm:leading-snug">
            {language === 'ur' ? (
              <>ماہانہ راشن کی مکمل لسٹ اور گھریلو سودا سلف گائیڈ</>
            ) : language === 'roman-urdu' ? (
          ...
          <p className="text-base sm:text-lg text-slate-700 leading-relaxed max-w-2xl mx-auto">
            {language === 'ur'
              ? 'چکی کے آٹے اور باسمتی چاول سے لے کر دالوں، گھی، چائے اور گھریلو صفائی تک۔ پاکستانی خاندانوں کے لیے مہینے کا سودا سلف بغیر کسی پریشانی اور بھول چوک کے ترتیب دینے کی عملی گائیڈ۔'
              : language === 'roman-urdu'
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              {addedListSuccess ? (
                <>
                  ...
                  <span>{language === 'ur' ? 'لسٹ یاد میں شامل ہوگئی!' : 'List Added to YAAD!'}</span>
                </>
              ) : (
                <>
            ...
            >
              <span>{language === 'ur' ? 'اپنی مرضی کی لسٹ بنائیں' : 'Create Custom List'}</span>
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-4">
          <h2 className="text-xl sm:text-2xl font-bold text-[#003d2b]">
            {language === 'ur'
              ? 'ماہانہ راشن کی خریداری کے عمومی مسائل'
              : language === 'roman-urdu'
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-slate-700 leading-relaxed pt-2">
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-2">
              ...
              <h3 className="font-bold text-slate-900">
                {language === 'ur' ? 'کاغذ کی لسٹ کا گم ہونا یا کٹنا' : 'Lost Notes & Forgotten Items'}
              </h3>
              <p>
                {language === 'ur'
                  ? 'کاغذ کی پرچی پر لکھی لسٹ دکان میں گم ہوجاتی ہے یا گھریلو فون کال پر بتائی گئی چیزیں کٹ جانے سے بھول جاتی ہیں۔'
            ...
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-2">
              ...
              <h3 className="font-bold text-slate-900">
                {language === 'ur' ? 'دکان میں آگے پیچھے چکر کاٹنا' : 'Aisle Backtracking Fatigue'}
              </h3>
              <p>
                {language === 'ur'
                  ? 'غیر منظم لسٹ کی وجہ سے کبھی دالوں کا رخ کرنا پڑتا ہے اور کبھی دوبارہ صفائی کے ریک کی طرف واپس جانا پڑتا ہے۔'
            ...
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-2">
              ...
              <h3 className="font-bold text-slate-900">
                {language === 'ur' ? 'یاد کا اسمارٹ حل' : 'YAAD’s Intelligent Memory'}
              </h3>
              <p>
                {language === 'ur'
                  ? 'یاد ایپ خودکار طور پر تمام سودا سلف کو دکان کے حصوں کے مطابق ترتیب دیتی ہے تاکہ آپ ایک ہی چکر میں خریداری مکمل کریں۔'
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2 className="text-2xl sm:text-3xl font-extrabold text-[#003d2b]">
                {language === 'ur'
                  ? 'ماہانہ راشن کی درجہ بندی شدہ فہرست'
                  : language === 'roman-urdu'
              ...
              <p className="text-sm text-slate-600 mt-1">
                {language === 'ur'
                  ? 'اوسط پاکستانی گھرانے کے لیے ۴ ہفتوں کے سودا سلف کے معیاری اندازے۔'
            ...
            <div className="flex flex-wrap gap-1.5 overflow-x-auto pb-1">
              ...
              >
                {language === 'ur' ? 'تمام اجزاء' : 'All Categories'}
              </button>
          ...
          <div className="p-6 rounded-3xl bg-linear-to-br from-[#005039] to-[#003d2b] text-white flex flex-col sm:flex-row items-center justify-between gap-6 shadow-md">
            <div className="space-y-1 text-center sm:text-left">
              <h4 className="text-lg font-bold">
                {language === 'ur'
                  ? 'کیا آپ یہ تمام چیزیں اپنی یاد لسٹ میں شامل کرنا چاہتے ہیں؟'
                  : 'Ready to take this checklist with you to the store?'}
              </h4>
              <p className="text-xs text-white/80">
                {language === 'ur'
                  ? 'ایک کلک میں اپنے موبائل میں کھولیں اور بازار میں بغیر انٹرنیٹ ٹک کرتے جائیں۔'
            ...
            >
              {addedListSuccess
                ? (language === 'ur' ? 'شامل ہوگئی ✓' : 'Added to YAAD ✓')
                : (language === 'ur' ? 'لسٹ لوڈ کریں' : 'Load Checklist')}
            </button>
          </div>
        </section>
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-6">
          <div className="space-y-1">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-[#003d2b]">
              {language === 'ur'
                ? 'پاکستانی منڈی و کریانہ کے روایتی پیمانے'
                : 'Traditional Pakistani Measurement Units Guide'}
            </h2>
            <p className="text-sm text-slate-600">
              {language === 'ur'
                ? 'لوکل کریانہ اور سبزی منڈی میں خریداری کرتے وقت کلو، پاؤ اور دھڑی کو سمجھنا ضروری ہے۔'
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-6">
          <div className="space-y-1">
            <h2 className="text-xl sm:text-2xl font-bold text-[#003d2b]">
              {language === 'ur'
                ? 'راشن کی حفاظت اور بجٹ بچانے کے ۴ سنہری اصول'
                : '4 Golden Rules for Household Rashan Management'}
            </h2>
            <p className="text-sm text-slate-600">
              {language === 'ur'
                ? 'ماہانہ راشن کو نمی، کیڑوں اور فضول خرچی سے بچانے کے گھریلو طریقے'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-slate-700">
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-1.5">
              <h3 className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span>{language === 'ur' ? 'خریداری سے پہلے الماری کا معائنہ' : 'The "Dry Pantry Shake"'}</span>
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                {language === 'ur'
                  ? 'مارکیٹ جانے سے پہلے دالوں اور مصالحوں کے ڈبوں کو ہلا کر دیکھیں کہ کتنا پرانا ذخیرہ باقی ہے۔ کبھی بھی بچی ہوئی چیز کو دوبارہ نہ خریدیں۔'
            ...
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-1.5">
              <h3 className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span>{language === 'ur' ? 'آٹے کو کیڑے سے محفوظ رکھنا' : 'Weevil Protection for Atta'}</span>
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                {language === 'ur'
                  ? 'مون سون اور گرمی میں آٹے کے ڈبے میں خشک تیز پات یا ثابت لونگ رکھیں تاکہ سسری اور کیڑا نہ لگے۔'
            ...
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-1.5">
              <h3 className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span>{language === 'ur' ? 'ثابت مصالحوں کی خریداری' : 'Buy Whole Spices in Bulk'}</span>
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                {language === 'ur'
                  ? 'ثابت زیرہ اور کالی مرچ خرید کر گھر میں پسوانا بازار کے کھلے پسے مصالحوں سے زیادہ خالص اور سستا ہوتا ہے۔'
            ...
            <div className="p-4 rounded-2xl bg-[#fbf9f5] border border-slate-100 space-y-1.5">
              <h3 className="font-bold text-slate-900 flex items-center gap-2">
                ...
                <span>{language === 'ur' ? 'کریانہ بمقابلہ سپر مارکیٹ' : 'Kiryana Provision vs Supermarket'}</span>
              </h3>
              <p className="text-xs text-slate-600 leading-relaxed">
                {language === 'ur'
                  ? 'دالیں، گھی اور آٹا لوکل کریانہ اسٹور یا تھوک منڈی سے خریدنا برانڈڈ سپر مارکیٹوں کی نسبت ۱۵ سے ۲۰ فیصد سستا پڑتا ہے۔'
        ...
        <section className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-slate-600">
              {language === 'ur'
                ? 'راشن لسٹ اور یاد ایپ کے استعمال سے متعلق فوری جوابات۔'
        ...
        <section className="text-center p-8 sm:p-12 rounded-3xl bg-[#005039] text-white space-y-5 shadow-lg">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight">
            {language === 'ur'
              ? 'اگلی خریداری پر کوئی چیز مت بھولیں'
              : 'Never Forget What You Need to Buy Again'}
          </h2>

          <p className="text-sm sm:text-base text-white/80 max-w-xl mx-auto leading-relaxed">
            {language === 'ur'
              ? 'یاد ایپ پاکستانی خاندانوں کے لیے بنائی گئی ہے جو اردو اور انگریزی دونوں زبانوں میں کام کرتی ہے اور کسی اشتہار یا فیس کے بغیر دستیاب ہے۔'
          ...
          <div className="pt-2 flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            >
              {language === 'ur' ? 'براہ راست ایپ کھولیں' : 'Open YAAD Directly'}
            </button>
          </div>
        </section>
        ...
        <footer className="pt-8 border-t border-slate-200/80 text-xs text-slate-500 space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <span className="font-bold text-[#005039]">YAAD (یاد)</span>
              <span>•</span>

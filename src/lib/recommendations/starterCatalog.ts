...
export const CONTEXT_STARTER_ITEMS: Record<string, StarterCatalogItem[]> = {
  ...
  supermarket: [
    ...
    {
      canonicalName: 'laundry_detergent',
      displayName: 'Laundry Detergent / Surf',
      nameUrdu: 'سرف / ڈٹرجنٹ',
      nameRomanUrdu: 'Surf',
      category: 'household',
      emoji: '🧺',
    ...
    {
      canonicalName: 'dish_soap',
      displayName: 'Dishwashing Soap / Liquid',
      nameUrdu: 'برتن دھونے کا صابن',
      nameRomanUrdu: 'Dish Soap',
      category: 'household',
      emoji: '🧼',
  ...
  baking: [
    {
      canonicalName: 'flour',
      displayName: 'Maida / All Purpose Flour',
      nameUrdu: 'میدہ',
      nameRomanUrdu: 'Maida',
      category: 'grains',
      emoji: '🌾',
    ...
    {
      canonicalName: 'baking_powder',
      displayName: 'Baking Powder',
      nameUrdu: 'بیکنگ پاؤڈر',
      nameRomanUrdu: 'Baking Powder',
      category: 'cooking_essentials',
      emoji: '🧁',
      defaultQuantity: '1',
      defaultUnit: 'tin',
    ...
    {
      canonicalName: 'cocoa_powder',
      displayName: 'Cocoa Powder',
      nameUrdu: 'کوکو پاؤڈر',
      nameRomanUrdu: 'Cocoa Powder',
      category: 'cooking_essentials',
      emoji: '🍫',
      defaultQuantity: '1',
      defaultUnit: 'box',
  ...
  personal: [
    {
      canonicalName: 'bath_soap',
      displayName: 'Bath Soap',
...
export function getStarterRecommendations(
  ...
  else if (resolvedCtx === 'breakfast' || resolvedCtx === 'nashta') resolvedCtx = 'breakfast';
  else if (resolvedCtx === 'supermarket' || resolvedCtx === 'mart') resolvedCtx = 'supermarket';
  else if (resolvedCtx === 'baking' || resolvedCtx === 'sweet') resolvedCtx = 'baking';
  else if (resolvedCtx === 'personal' || resolvedCtx === 'hygiene') resolvedCtx = 'personal';

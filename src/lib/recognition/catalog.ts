...
const CORE_CANONICAL_ITEMS: CanonicalItemRecord[] = [
  ...
  {
    id: 'dish_soap',
    canonical_name: 'Dishwashing Soap',
    english_name: 'Dishwashing Soap',
    urdu_name: 'برتن دھونے کا صابن',
    roman_urdu_names: ['Dish Soap', 'Dishwash', 'Bartan ka Sabun', 'Vim Bar', 'Lemon Max'],
    aliases: [
      'dish soap', 'dishsoap', 'dish wash', 'dishwash', 'dishwashing soap', 'dishwashing bar', 'dishwashing liquid', 'dish soap bar', 'dish bar', 'dish liquid',
      'vim', 'vim bar', 'lemon max', 'lemon max bar', 'max bar',
      'bartan dhonay ka sabun', 'bartan wala sabun', 'bartan ka sabun',
      'برتن دھونے کا صابن', 'وم بار', 'ڈش واش', 'ڈش سوپ',
    ],
    category: 'cleaning',
    subcategory: 'Dishwashing',
    common_spellings: ['dish wash', 'dishsoap', 'vimbar', 'lemonmax'],
    confidence: 0.98,
    active: true,
    emoji: '🧼',
    defaultUnit: 'pcs',
  ...
  {
    id: 'charcoal',
    canonical_name: 'Charcoal (Koyla)',
    english_name: 'Charcoal',
    urdu_name: 'کوئلہ',
    roman_urdu_names: ['Koyla', 'Charcoal', 'Koela'],
    aliases: [
      'charcoal', 'char coal', 'koyla', 'koela', 'bbq coal', 'coal', 'bbq charcoal',
      'کوئلہ',
    ],
    category: 'household',
    subcategory: 'BBQ Supplies',
    common_spellings: ['koyla', 'koela', 'charcol', 'charcoal'],
    confidence: 0.98,
    active: true,
    emoji: '🪵',
    defaultUnit: 'kg',
    canonicalName: 'Charcoal (Koyla)',
    nameUrdu: 'کوئلہ',
    nameRomanUrdu: 'Koyla',
    categoryId: 'household',
  },
  {
    id: 'tikka_masala',
    canonical_name: 'Tikka Masala',
    english_name: 'Tikka Masala',
    urdu_name: 'تکہ مصالحہ',
    roman_urdu_names: ['Tikka Masala', 'BBQ Masala', 'Tikka Boti Masala'],
    aliases: [
      'tikka masala', 'tikka boti masala', 'bbq masala', 'shan tikka masala', 'national tikka masala',
      'تکہ مصالحہ', 'تکہ بوٹی مصالحہ',
    ],
    category: 'spices',
    subcategory: 'Recipe Mixes',
    common_spellings: ['tika masala', 'tikka masla'],
    confidence: 0.98,
    active: true,
    emoji: '🌶️',
    defaultUnit: 'packet',
    canonicalName: 'Tikka Masala',
    nameUrdu: 'تکہ مصالحہ',
  ...
  },
  {
    ...
    english_name: 'Paratha',
    urdu_name: 'پراٹھا',
    roman_urdu_names: ['Paratha', 'Frozen Paratha', 'Lachha Paratha'],
    aliases: [
      'paratha', 'parathas', 'plain paratha', 'frozen paratha', 'dawn paratha', 'k&ns paratha', 'lachha paratha',
      'پراٹھا', 'پراٹھے',
    ],
    category: 'bakery',
    subcategory: 'Frozen Breads',
    common_spellings: ['pratha', 'paratha', 'parata'],
    confidence: 0.98,
    active: true,
    emoji: '🫓',
    defaultUnit: 'packet',
  ...
  {
    id: 'handwash',
    canonical_name: 'Handwash',
    english_name: 'Handwash',
    urdu_name: 'ہینڈ واش',
    roman_urdu_names: ['Handwash', 'Hand Wash', 'Liquid Soap'],
    aliases: [
      'handwash', 'hand wash', 'liquid handwash', 'liquid hand soap', 'dettol handwash', 'lifebuoy handwash',
      'ہینڈ واش',
    ],
    category: 'personal_care',
    subcategory: 'Bath & Hand Care',
    common_spellings: ['hand wash', 'handwash'],
    confidence: 0.98,
    active: true,
    emoji: '🧴',
    defaultUnit: 'bottle',
    canonicalName: 'Handwash',
    nameUrdu: 'ہینڈ واش',
    nameRomanUrdu: 'Handwash',
    categoryId: 'personal_care',
  },
  {
    id: 'deodorant',
    canonical_name: 'Deodorant / Body Spray',
    english_name: 'Deodorant',
    urdu_name: 'باڈی اسپرے / ڈیوڈرینٹ',
    roman_urdu_names: ['Deodorant', 'Body Spray', 'Axe', 'Fogg'],
    aliases: [
      'deodorant', 'deodrant', 'body spray', 'bodyspray', 'axe spray', 'fogg', 'perfume spray', 'roll on',
      'باڈی اسپرے', 'ڈیوڈرینٹ',
    ],
    category: 'personal_care',
    subcategory: 'Fragrances & Grooming',
    common_spellings: ['deodrant', 'bodyspray', 'fog'],
    confidence: 0.98,
    active: true,
    emoji: '✨',
    defaultUnit: 'bottle',
    ...
    nameUrdu: 'باڈی اسپرے',
    nameRomanUrdu: 'Deodorant',
    categoryId: 'personal_care',
  },
  {
    id: 'mop_broom',
    canonical_name: 'Mop / Broom',
    english_name: 'Mop / Broom',
    urdu_name: 'جھاڑو اور پوچھا',
    roman_urdu_names: ['Mop', 'Broom', 'Jharoo', 'Pocha'],
    aliases: [
      'mop', 'broom', 'mop / broom', 'floor mop', 'pocha', 'jharoo', 'jharu', 'safai mop',
      'جھاڑو', 'پوچھا',
    ],
    category: 'cleaning',
    subcategory: 'Cleaning Supplies',
    common_spellings: ['jharu', 'pocha', 'broom'],
    confidence: 0.98,
    active: true,
    emoji: '🧹',
    defaultUnit: 'pcs',
    canonicalName: 'Mop / Broom',
    nameUrdu: 'جھاڑو اور پوچھا',
    nameRomanUrdu: 'Mop / Broom',
    categoryId: 'cleaning',
  },
];
